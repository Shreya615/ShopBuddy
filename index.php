        ...
        <div class="main max-h-max flex ">
            ...
            p-6">
                <div class="sidebar-categories">
			        ...
			        ?>
			        <span class=" "><a href="category1.php?id=<?php echo $list['id']?>"><?php echo $list['categories']?></a><br></span>
			        <?php
		                }
					?>
                   ...
                   <div class="sidebar-main-category cursor-pointer text-slate-700
                    flex font-bold mb-8 p-2 hover:bg-gray-400 rounded-lg">
                       <span class="w-8">
                       ...
                       <a href="login_admin.php"><span>Admin Login</span></a>
                   </div>
            ...
            <div class="main-section flex-1 p-4">
                ...
                <div class="main-section-deals">
                    <h1 class=" font-bold text-xl mt-0">New Arrivals🔥</h1>
